...
local Library do 
    ...
    local LucideIcons do
        local Success, Result = pcall(function()
            return loadstring(game:HttpGet("https://raw.githubusercontent.com/Orvez83/IconFinder/refs/heads/main/Icons/Lucide-Icons.lua"))()
        end)

        LucideIcons = (Success and type(Result) == "table") and Result or {}
    end
    ...
    local function ResolveIcon(Icon)
        ...
        if StringFind(Icon, "^%d+$") then
            return Icon
        end

        if StringFind(Icon, "rbxassetid://") then
            return (StringGSub(Icon, "rbxassetid://", ""))
        end

        local LucideId = LucideIcons[StringLower(Icon)]

        if LucideId then
            return (StringGSub(LucideId, "rbxassetid://", ""))
        end
    ...
    do
        ...
        Library.CreateKeybind = function(self, Data)
            ...
            Items["KeyButton"]:Connect("MouseButton1Click", function()
                if UserInputService.TouchEnabled and not UserInputService.KeyboardEnabled then
                    local PreviousText = Items["KeyButton"].Instance.Text
                    Items["KeyButton"].Instance.Text = "N/A"

                    task.delay(1, function()
                        if Items["KeyButton"].Instance.Text == "N/A" then
                            Items["KeyButton"].Instance.Text = PreviousText
                        end
                    end)
        ...
        Library.Notification = function(self, Name, Icon, Duration)
            Icon = ResolveIcon(Icon) or "90449909165261"
        ...
        Library.Page = function(self, Data)
            ...
            local Page = {
                ...
                Icon = ResolveIcon(Data.Icon or Data.icon) or "131145598162617",
